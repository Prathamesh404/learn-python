...
class User(object):
    """
    Docstring for User, this class can be used to make different methods
    """
    def __init__(self, full_name, date_of_birth): # init method, initialization a.k.a "Constructor"
        ...
        self.first_name = name_pieces[0] #which element is at index 0 in an array due to split method
        self.last_name = name_pieces[-1] # here "-1" indicates last value, but eventually a second value. 'Devashish Rateshwar'
...
user = User("Devashish Rateshwar", "19650705")
